...
export default function Footer() {
  const socialLinks = [
    ...
    {
      label: "LinkedIn",
      href: "https://www.linkedin.com/company/bhutan-thailand-chamber-of-commerce/about/",
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    {
      label: "Instagram",
      href: "https://www.instagram.com/bhtcc__/",
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div>
            <a href="/" className="inline-block">
              <Image src="/BHTCClong.png" alt="BHTCC" width={300} height={100} className="object-contain block" style={{ height: '100px', width: 'auto' }} />
            </a>
