...
export default function Membership() {
  return (
    <section id="membership" className="py-20 lg:py-28" style={{ backgroundColor: "#E8F4F2" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-md transition-shadow duration-300">
            <div className="mb-6">
              <h3 className="text-xl font-bold mb-1" style={{ color: "#1B5558" }}>
                ...
                <li key={benefit} className="flex items-start gap-3">
                  ...
                  >
                    <svg width="10" height="8" viewBox="0 0 10 8" fill="none">
                      <path d="M1 4L3.5 6.5L9 1" stroke="#1B5558" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </span>
            ...
            <a
              href="#contact"
              className="block text-center px-6 py-3 rounded-full text-sm font-semibold border-2 transition-all duration-200 hover:bg-[#1B5558] hover:text-white"
            ...
            <ul className="space-y-3 mb-8">
              {corporateBenefits.map((benefit) => (
                <li key={benefit} className="flex items-start gap-3">
                  ...
                  >
                    <svg width="10" height="8" viewBox="0 0 10 8" fill="none">
                      <path d="M1 4L3.5 6.5L9 1" stroke="#C5973E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </span>
                  <span className="text-gray-600 text-sm leading-relaxed">{benefit}</span>
                </li>
